...
export default function RealEstateBidSection({ item, onMakeItMine, onCancel }) {
  ...
  useEffect(() => {
    ...
    priceTickRef.current = setInterval(() => {}, 5000);
  ...
  const confirmMutation = useMutation({
    mutationFn: async () => {
      ...
      const serviceFee = 500; // Flat $500 for Real Estate
