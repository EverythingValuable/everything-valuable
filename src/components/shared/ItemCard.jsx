          ...
          {item.images?.[0] ? (
            <>
              <img
                src={item.images[0]}
                alt={item.title}
                className={`w-full h-full object-contain transition-opacity duration-700 ${item.images[1] ? "group-hover:opacity-0" : "group-hover:scale-105 transition-transform duration-700"}`}
              />
              {item.images[1] && (
                <img
                  src={item.images[1]}
